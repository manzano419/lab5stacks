...
public class CircularDoublyLinkedQueue<E> implements Deque<E>{
	...
	public E removeFirst() {	
		...
		Node<E> toElim = header.getNext();
		E temp = toElim.getElement();
		header.setNext(toElim.getNext());
		toElim.getNext().setPrev(header);
	...
	public E removeLast() {
		...
		Node<E> toElim = header.getPrev();
		E temp = toElim.getElement();
		
		header.setPrev(toElim.getPrev());
		toElim.getPrev().setNext(header);
	...
	public E getFirst() {
		/*TODO ADD YOUR CODE HERE*/
		return header.getNext().getElement(); // Dummy Return
	}

	@Override
	public E getLast() {
		/*TODO ADD YOUR CODE HERE*/
		return header.getPrev().getElement(); // Dummy Return
	}
	...
	public int size() {
		/*TODO ADD YOUR CODE HERE*/
		return currentSize; // Dummy Return
	}
